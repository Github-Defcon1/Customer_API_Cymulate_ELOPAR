...
module = "immediate-threats"  # immediate-threats, mail, browsing, waf, edr, dlp, hopper
payload = {}
headers = {
    'x-token': f'{xtoken}'
}
...
def process_assessment_id(assessment_id, env_name, env_id):
    url_report = f"https://api.app.cymulate.com/v1/{module}/history/technical/{assessment_id}"
